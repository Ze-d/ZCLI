...
| Subagent、Team 与 Worktree | [architecture/agents-teams-worktrees.md](architecture/agents-teams-worktrees.md) |
...
- **测试**: pytest，覆盖 Agent、Memory、Session、Skill、MCP、Subagent、Team、Worktree、压缩和错误恢复核心路径
